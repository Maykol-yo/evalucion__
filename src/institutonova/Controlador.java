    ...
    public static void main(String[] args) {
        ...
        while (rpta.equalsIgnoreCase("si")) {
            try {
                ...
                // Instanciación y validación automática[cite: 3]
             
                a = new Alumno(nombre, tipo, numero, nivel, beca);
                ctrl.agregarAlumno(a);
                
                System.out.println("\n[SISTEMA] Alumno registrado con éxito.");

            } catch (Exception e) {
                // Captura y muestra errores de validación sin cerrar el programa[cite: 3]
                System.out.println("\n[ERROR] " + e.getMessage());
            }
        ...
        // Mostrar lista final antes de cerrar[cite: 3]
        ctrl.listarAlumnos();
